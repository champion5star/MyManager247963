...
export default function Note({ item, zoom }) {
    // ** States
    ...
    return (
       ...
       {state?( <div
        ...
        >
            ...
            >
                <AlignLeft onClick={handleState} style={{cursor:"pointer"}}/> {item?.addText || "Note"}
            </div>
        </div>): <div
            className="box"
            style={{
        ...
        >
            ...
            >
                <AlignLeft onClick={handleState} style={{cursor:"pointer"}} className="text-primary"/> 
            </div>
        </div>}
       </>
    )
