                            ...
                            <Form id={i + 1}>
                                <Row>
                                    <Col md={6}>
                                        ...
                                        <Input type="text" name="value" value={selectedItem.list &&  selectedItem?.list[i]?.value} onChange={handleOnChange} />
                                    </Col>
                                    <Col md={6}>
                                        <Label
                                        ...
                                        <Input type="text" name='name' onChange={handleOnChange} value={selectedItem.list && selectedItem?.list[i]?.name} />
                                    </Col>
                                </Row>
                            </Form>
                        </Tag>
