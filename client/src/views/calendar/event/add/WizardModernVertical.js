...
const WizardModernVertical = () => {
    ...
    const steps = [
        ...
        },
        {
            ...
            icon: <User size={18} />,
            content: <Host payload={payload} setPayload={setPayload} stepper={stepper} type="modern-vertical" />
        },
        {
            id: 'venue',
            title: 'Venue',
            ...
            icon: <MapPin size={18} />,
            content: <Venue payload={payload} setPayload={setPayload} stepper={stepper} type="modern-vertical" />
        },
        {
            id: 'tickets',
            title: 'Tickets',
            ...
            icon: <Tool size={18} />,
            content: <Tickets payload={payload} setPayload={setPayload} stepper={stepper} type="modern-vertical" />
        }
    ]
