...
import { addNewFolder, deleteFolder, getFileAndFolders, prevPath, renameFolder, uploadFile } from './store';
  ...
  const renderFolders = () => {
    ...
    return (
      <Row className="match-height bg-white p-2">
        ...
        <Col md="6" lg="4" xl="3" sm="12">
          <Card className="h-70 shadow-none text-center border cursor-pointer d-flex justify-content-center align-items-center" onClick={() => setIsAddFolderModalOpen(true)}>
  ...
  const renderFiles = () => {
    ...
    return (
      <Row className="match-height bg-white p-2">
        ...
        <Col md="6" lg="4" xl="3" sm="12">
          <Card className="h-70 shadow-none text-center border cursor-pointer d-flex justify-content-center align-items-center" onClick={() => handleFileUpload()}>
