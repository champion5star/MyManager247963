...
const Sidebar = props => {
    ...
    const { store, sidebarOpen, toggleCompose, dispatch, getMails, resetSelectedMail, setSidebarOpen, subFolderActive,
        setSubFolderActive, setSubFolderActiveName, activeFolder, setActiveFolder } = props
    const {
        GET_CATEGORIES_EMAIL,
        GET_SCHEDULE_MAILS,
        ADD_NEW_MAIN_FOLDER_EMAIL
                        ...
                        <PerfectScrollbar className='sidebar-menu-list' options={{ wheelPropagation: false }}>
                            ...
                            {addFolderHide ? (
                                <div className='m-2'>
                                    <Form>
                                        <InputGroup>
                                            <Input onChange={handleChange} placeholder={"Folder Name"} required name={"categoryName"}/>
                                            <Button
                                                type="submit"
                                                color='primary'
                                                outline autoFocus
