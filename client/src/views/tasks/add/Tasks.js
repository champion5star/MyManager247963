    ...
    return (
        <Fragment>
                        ...
                        >
                            ...
                            <div>
                                <ListGroup className="list-group-horizontal-sm">
                                    ...
                                    <ListGroupItem
                                        className={`${
                                            item.repeat.includes('wednesday')
                                                ? 'active'
                                                : ''
                                        }  bg-light text-dark`}
                                    >
            ...
            <Modal
                ...
                toggle={() =>
                    setDeleteModal((p) => ({ _id: '', modal: false }))
                }
