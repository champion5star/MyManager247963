...
const NewTodo = (props) => {
    ...
    // todo add
    const initialTodo = [
        { id: 0, title: '', dateTime: new Date(), proofType: '' }
    ]
    ...
    const increaseCount = () => {
        ...
        setTodos((p) => [
            ...p,
            { title: '', dateTime: new Date(), proofType: '', id: p.length }
        ])
    }
    ...
    const { loading: saveCheckListLoading, success: savCheckListSuccess } =
        saveCheckList
    useMemo(() => {
        ...
        <Fragment>
            ...
            >
                            ...
                            <ButtonGroup className="mb-1">
                                <Button
                                    ...
                                    onClick={() => {
                                        setRSelected('check')
                                        setTodos((p) => {
                                            let findIndex = p.findIndex(
                                                (x) =>
                                                    x.id ===
                                                    selectPfoofTypeIndex
                                            )
                                            if (findIndex > -1) {
                ...
                <ModalFooter>
                    <Button
                        color="primary"
                        onClick={() => setProofTypeModal(!proofTypesModal)}
                    >
                        Select
                    </Button>
                </ModalFooter>
