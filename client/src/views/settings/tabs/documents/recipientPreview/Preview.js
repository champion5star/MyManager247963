...
export default function Preview() {
    ...
    // ** Context
   const{board,scale,setBoard,setScale,setRecipients,setHashcode,hashcode} = useContext(DocumentContext)
            ...
            return(
                <Tag key={i} className="d-flex ">
                    ...
                    <div
                        ...
                        >
                            {
                                board.filter((x) => x.page === (i + 1)&& x.recipient.hashCode===hashcode).map((item,idx)=>{
                                    switch (item?.type) {
                                        case 'sign':
                                            return (
                                                <Sign
